...
public class CPU
{
    ...
    public int Step() {
        ...
        switch (opcode) {
            ...
            case 0x32: mmu.Write(HL--, A);                         break; //LD (HL-),A 1 8     ----
            case 0x33: SP += 1;                                        break; //INC SP     1 8     ----
            case 0x34: mmu.Write(HL, INC(mmu.Read(HL)));       break; //INC (HL)   1 12    Z0H-
            case 0x35: mmu.Write(HL, DEC(mmu.Read(HL)));       break; //DEC (HL)   1 12    Z1H-
            case 0x36: mmu.Write(HL, mmu.Read(PC)); PC += 1;   break; //LD (HL),D8 2 12    ----
            ...
            case 0x46: B = mmu.Read(HL);  break; //LD B,(HL)	1 8	   ----
            ...
            case 0x4E: C = mmu.Read(HL);  break; //LD C,(HL)	1 8    ----
            ...
            case 0x56: D = mmu.Read(HL);  break; //LD D,(HL)    1 8    ---- 
            ...
            case 0x5E: E = mmu.Read(HL);  break; //LD E,(HL)    1 8    ----
            ...
            case 0x66: H = mmu.Read(HL);  break; //LD H,(HL)    1 8    ----
            ...
            case 0x6E: L = mmu.Read(HL);  break; //LD L,(HL)	1 8    ----
            case 0x6F: L = A;                 break; //LD L,A	    1 4    ----
                                                
            case 0x70: mmu.Write(HL, B);  break; //LD (HL),B	1 8    ----
            case 0x71: mmu.Write(HL, C);  break; //LD (HL),C	1 8	   ----
            case 0x72: mmu.Write(HL, D);  break; //LD (HL),D	1 8	   ----
            case 0x73: mmu.Write(HL, E);  break; //LD (HL),E	1 8	   ----
            case 0x74: mmu.Write(HL, H);  break; //LD (HL),H	1 8	   ----
            case 0x75: mmu.Write(HL, L);  break; //LD (HL),L	1 8	   ----
            case 0x76: HALT();             break; //HLT	        1 4    ----
            case 0x77: mmu.Write(HL, A);  break; //LD (HL),A	1 8    ----
            ...
            case 0x7E: A = mmu.Read(HL);  break; //LD A,(HL)    1 8    ----
            ...
            case 0x86: ADD(mmu.Read(HL)); break; //ADD M	    1 8    Z0HC	
            ...
            case 0x8E: ADC(mmu.Read(HL)); break; //ADC M	    1 8    Z0HC	
            ...
            case 0x96: SUB(mmu.Read(HL)); break; //SUB M	    1 8    Z1HC
            ...
            case 0x9E: SBC(mmu.Read(HL)); break; //SBC M	    1 8    Z1HC
            ...
            case 0xA6: AND(mmu.Read(HL)); break; //AND M	    1 8    Z010
            ...
            case 0xAE: XOR(mmu.Read(HL)); break; //XOR M	    1 8    Z000
            ...
            case 0xB6: OR(mmu.Read(HL));  break; //OR M     	1 8    Z000
            ...
            case 0xBE: CP(mmu.Read(HL));  break; //CP M     	1 8    Z1HC
            ...
            case 0xC6: ADD(mmu.Read(PC)); PC += 1;  break; //ADD A,D8    2 8     Z0HC
            ...
            case 0xCB: PREFIX_CB(mmu.Read(PC++));      break; //PREFIX CB OPCODE TABLE
            case 0xCC: CALL(FlagZ);                break; //CALL Z,A16  3 24/12 ----
            case 0xCD: CALL(true);                 break; //CALL A16    3 24    ----
            case 0xCE: ADC(mmu.Read(PC)); PC += 1;  break; //ADC A,D8    2 8     ----
            ...
            case 0xD6: SUB(mmu.Read(PC)); PC += 1;  break; //SUB D8      2 8     ----
            ...
            case 0xFA: A = mmu.Read(mmu.ReadROM16(PC)); PC += 2;   break; //LD A,(A16)  3 16    ----
            case 0xFB: IMEEnabler = true;               break; //IE          1 4     ----
            //case 0xFC:                                break; //Illegal Opcode
            //case 0xFD:                                break; //Illegal Opcode
            case 0xFE: CP(mmu.Read(PC)); PC += 1;   break; //CP D8       2 8     Z1HC
    ...
    private void PREFIX_CB(byte opcode) {
        switch (opcode) {
            ...
            case 0x06: mmu.Write(HL, RLC(mmu.Read(HL)));    break; //RLC (HL) 2   8   Z00C
            ...
            case 0x0E: mmu.Write(HL, RRC(mmu.Read(HL)));    break; //RRC (HL) 2   8   Z00C
            ...
            case 0x16: mmu.Write(HL, RL(mmu.Read(HL)));     break; //RL (HL)  2   8   Z00C
            ...
            case 0x1E: mmu.Write(HL, RR(mmu.Read(HL)));     break; //RR (HL)  2   8   Z00C
            ...
            case 0x26: mmu.Write(HL, SLA(mmu.Read(HL)));    break; //SLA (HL) 2   8   Z00C
            ...
            case 0x2E: mmu.Write(HL, SRA(mmu.Read(HL)));    break; //SRA (HL) 2   8   Z00C
            ...
            case 0x36: mmu.Write(HL, SWAP(mmu.Read(HL)));   break; //SWAP (HL) 2   8   Z00C
            ...
            case 0x3E: mmu.Write(HL, SRL(mmu.Read(HL)));    break; //SRL (HL) 2   8   Z000
            ...
            case 0x46: BIT(0x1, mmu.Read(HL));                  break; //BIT (HL) 2   8   Z01-
            ...
            case 0x4E: BIT(0x2, mmu.Read(HL));                 break; //BIT (HL) 2   8   Z01-
            ...
            case 0x56: BIT(0x4, mmu.Read(HL));                 break; //BIT (HL) 2   8   Z01-
            ...
            case 0x5E: BIT(0x8, mmu.Read(HL));                 break; //BIT (HL) 2   8   Z01-
            ...
            case 0x66: BIT(0x10, mmu.Read(HL));                break; //BIT (HL) 2   8   Z01-
            ...
            case 0x6E: BIT(0x20, mmu.Read(HL));                break; //BIT (HL) 2   8   Z01-
            ...
            case 0x76: BIT(0x40, mmu.Read(HL));                break; //BIT (HL) 2   8   Z01-
            ...
            case 0x7E: BIT(0x80, mmu.Read(HL));                break; //BIT (HL) 2   8   Z01-
            ...
            case 0x86: mmu.Write(HL, RES(0x1, mmu.Read(HL))); break; //RES (HL) 2   8   ----
            ...
            case 0x8E: mmu.Write(HL, RES(0x2, mmu.Read(HL))); break; //RES (HL) 2   8   ----
            ...
            case 0x96: mmu.Write(HL, RES(0x4, mmu.Read(HL))); break; //RES (HL) 2   8   ----
            ...
            case 0x9E: mmu.Write(HL, RES(0x8, mmu.Read(HL))); break; //RES (HL) 2   8   ----
            ...
            case 0xA6: mmu.Write(HL, RES(0x10, mmu.Read(HL))); break; //RES (HL) 2   8   ----
            ...
            case 0xAE: mmu.Write(HL, RES(0x20, mmu.Read(HL))); break; //RES (HL) 2   8   ----
            ...
            case 0xB6: mmu.Write(HL, RES(0x40, mmu.Read(HL))); break; //RES (HL) 2   8   ----
            ...
            case 0xBE: mmu.Write(HL, RES(0x80, mmu.Read(HL))); break; //RES (HL) 2   8   ----
            ...
            case 0xC6: mmu.Write(HL, SET(0x1, mmu.Read(HL))); break; //SET (HL) 2   8   ----
            ...
            case 0xCE: mmu.Write(HL, SET(0x2, mmu.Read(HL))); break; //SET (HL) 2   8   ----
            ...
            case 0xD6: mmu.Write(HL, SET(0x4, mmu.Read(HL))); break; //SET (HL) 2   8   ----
            ...
            case 0xDE: mmu.Write(HL, SET(0x8, mmu.Read(HL))); break; //SET (HL) 2   8   ----
            ...
            case 0xE6: mmu.Write(HL, SET(0x10, mmu.Read(HL))); break; //SET (HL) 2   8   ----
            ...
            case 0xEE: mmu.Write(HL, SET(0x20, mmu.Read(HL))); break; //SET (HL) 2   8   ----
            ...
            case 0xF6: mmu.Write(HL, SET(0x40, mmu.Read(HL))); break; //SET (HL) 2   8   ----
            ...
            case 0xFE: mmu.Write(HL, SET(0x80, mmu.Read(HL))); break; //SET (HL) 2   8   ----
